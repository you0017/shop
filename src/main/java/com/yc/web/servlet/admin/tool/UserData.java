...
public class UserData implements DataInterface{
    ...
    public static DataModel allUserData (DataModel ud, HttpServletRequest request) throws InvocationTargetException, IllegalAccessException, InstantiationException, ParseException {
